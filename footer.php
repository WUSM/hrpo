    ...
    <div id="wusm-footer">
        ...
        <div class="wrapper clearfix">
            ...
            <div id="wusm-footer-left">
                <a onclick="javascript:_gaq.push(['_trackEvent','wusm-footer','http://wustl.edu/']);" href="http://wustl.edu/"><img src="<?php echo get_template_directory_uri(); ?>/_/img/wustl-logo-footer.png" alt="Washington University School of Medicine in St. Louis"></a>
